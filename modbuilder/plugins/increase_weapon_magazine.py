...
DESCRIPTION = "Increase the magazine size of all weapons. The weapon names are what is stored in the configuration files, so sorry if they are a bit confusing."
